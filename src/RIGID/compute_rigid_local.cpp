...
enum{ID,MOL,MASS,X,Y,Z,XU,YU,ZU,VX,VY,VZ,FX,FY,FZ,IX,IY,IZ,
     ...
     QUATW,QUATI,QUATJ,QUATK,INERTIAX,INERTIAY,INERTIAZ,EXX,EXY,EXZ,EYX,EYY,EYZ,EZX,EZY,EZZ};
  ...
  rstyle(nullptr), idrigid(nullptr), fixrigid(nullptr), vlocal(nullptr), alocal(nullptr)
{
  ...
  for (int iarg = 4; iarg < narg; iarg++) {
    ...
    else if (strcmp(arg[iarg],"exx") == 0) rstyle[nvalues++] = EXX;
    else if (strcmp(arg[iarg],"exy") == 0) rstyle[nvalues++] = EXY;
    else if (strcmp(arg[iarg],"exz") == 0) rstyle[nvalues++] = EXZ;
    else if (strcmp(arg[iarg],"eyx") == 0) rstyle[nvalues++] = EYX;
    else if (strcmp(arg[iarg],"eyy") == 0) rstyle[nvalues++] = EYY;
    else if (strcmp(arg[iarg],"eyz") == 0) rstyle[nvalues++] = EYZ;
    else if (strcmp(arg[iarg],"ezx") == 0) rstyle[nvalues++] = EZX;
    else if (strcmp(arg[iarg],"ezy") == 0) rstyle[nvalues++] = EZY;
    else if (strcmp(arg[iarg],"ezz") == 0) rstyle[nvalues++] = EZZ;
    ...
    if (flag) {
      ...
      for (n = 0; n < nvalues; n++) {
        ...
        case INERTIAZ:
          ...
          break;
        case EXX:
          ptr[n] = body->ex_space[0];
          break;
        case EXY:        
          ptr[n] = body->ex_space[1];
          break;
        case EXZ:        
          ptr[n] = body->ex_space[2];
          break;
        case EYX:        
          ptr[n] = body->ey_space[0];
          break;
        case EYY:        
          ptr[n] = body->ey_space[1];
          break;
        case EYZ:        
          ptr[n] = body->ey_space[2];
          break;
        case EZX:        
          ptr[n] = body->ez_space[0];
          break;
        case EZY:        
          ptr[n] = body->ez_space[1];
          break;
        case EZZ:        
          ptr[n] = body->ez_space[2];
          break;
        }
      }
    }
